...
public class BusEireann extends Vendor{
    ...
    public boolean bookTrip(Trip trip) {
        ...
        System.out.println("Booked trip with BusEireann from " + trip.getStartLoc()+" to " + trip.getDestLoc() );
        return true;
    }
}
